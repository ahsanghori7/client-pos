...
<!-- Main content -->
<?php echo form_open('panel/technicians/customer_actions', 'id="action-form"'); ?>
...
<div class="row">
  <div class="col-12">
    ...
    <div class="card-header d-flex p-0">
        <h3 class="card-title p-3"><?= lang('technician/index'); ?></h3>
            ...
            <li class="dropdown dropleft">
                    <div class="btn-group dropleft" style="list-style-type: none;">
                        ...
                        <ul class="dropdown-menu  tasks-menus" role="menu" aria-labelledby="dLabel">
                            ...
                            <a class="dropdown-item" href="<?=base_url();?>panel/technicians/export_csv">
...
<script type="text/javascript" src="<?=base_url();?>panel/misc/js/technician"></script>