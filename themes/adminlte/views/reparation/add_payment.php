...
<?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("panel/reparation/add_payment/" . $inv->id, $attrib); ?>
            ...
            <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?= lang("date", "date"); ?>
                            <input type="text" value="<?= $this->repairer->hrld(date('Y-m-d H:i:s'));?>" class="form-control datetimepicker-input" id="date" data-toggle="datetimepicker" data-target="#date"/>
                        </div>
                    </div>
                <div class="col-sm-6">
                    <div class="form-group">
