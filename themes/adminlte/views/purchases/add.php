  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-header">
              <h3 class="card-title"><i class="fa-fw fa fa-plus"></i><?= lang('add_purchase'); ?></h3>
          </div>
      <!-- /.card-header -->
      <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <?= lang('date', 'podate'); ?>
                                             ...
                                             <div class="input-group" id="podate" data-target-input="nearest">
                                                ...
                                                <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control datetimepicker-input" data-target="#podate" required="required"'); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form" id="purchase_form">
                        <div class="form-group">
