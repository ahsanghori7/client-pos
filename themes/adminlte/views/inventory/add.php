                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                                  <div class="form-group all">
                                    ...
                                    echo form_dropdown('supplier[]', $sup, set_value('supplier'), 'class="form-control select" multiple id="supplier" placeholder="' . lang("select") . " " . lang("supplier") . '" style="width:100%"')
                                    ?>
                                </div>
