<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    <div class="modal-content">
        ...
        echo form_open_multipart("panel/technicians/import_csv", $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>
            <div class="well well-small">
                <a href="<?php echo base_url(); ?>panel/technicians/export_csv" class="btn-icon btn btn-primary btn-icon pull-right"><i class="fa fa-download img-circle text-primary"></i> <?=lang('download_current_file');?></a>
